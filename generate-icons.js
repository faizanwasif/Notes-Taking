/**
 * PWA Icon Generator
 * Converts a single SVG icon into multiple PNG files at different resolutions required for a PWA
 * 
 * Usage: 
 * 1. npm install sharp fs-extra
...
// Configuration
const SOURCE_ICON = 'icon.svg'; // Your source SVG file
const OUTPUT_DIR = 'assets/icons';
const FAVICON_SIZE = 32; // Size for favicon.ico
...
async function generatePwaIcons() {
  try {
    ...
    // Generate favicon.ico (multiple sizes inside one file)
    console.log('Generating favicon.ico...');
    try {
      // For favicon.ico, we'll use a PNG as a simpler alternative
      ...
      console.log('Favicon.ico generated (as PNG).');
      console.log('For a true multi-size .ico file, consider using a dedicated ICO generator tool.');
    } catch (error) {
